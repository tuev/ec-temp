...
module.exports = {
  ...
  actions: data => {
    ...
    const path = '../src/components/molecules/'
    const actions = [
      {
        type: 'add',
      ...
      },
      {
        ...
        templateFile: './molecule/molecule.tsx.hbs',
        abortOnFail: true,
      },
      {
        type: 'add',
        path: path + '{{properCase name}}/{{properCase name}}.stories.tsx',
        templateFile: './molecule/stories.tsx.hbs',
        abortOnFail: true,
      },
      {
        type: 'add',
        path: path + '{{properCase name}}/{{properCase name}}.mdx',
        templateFile: './molecule/stories.mdx.hbs',
        abortOnFail: true,
      },
      {
        type: 'add',
        ...
        templateFile: './molecule/test.tsx.hbs',
        abortOnFail: true,
      },
    ]
    ...
    if (data.wantLoadable) {
      actions.push({
        ...
        templateFile: './molecule/loadable.tsx.hbs',
        abortOnFail: true,
      })
    }
    if (data.styled) {
      actions.push({
        ...
        templateFile: './molecule/styled.tsx.hbs',
        abortOnFail: true,
      })
    }
